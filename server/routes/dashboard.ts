...
<div class="intro">
  ...
  <p><strong>AI coaching transforms the goal artifact, not the psychological state.</strong> A2 goals are dramatically longer (95 vs 51 words, d=0.90) and rated much higher by independent human raters (d=1.21 on a 1–5 SMART composite). Within A2, every refinement round adds dates and measurable language (dates 40%→87%, numbers 69%→95%), and all five SMART dimensions improve initial→final (all p&lt;.01). But AI coaching also raises frustration (d=0.77) and does not move self-efficacy.</p>
  ...
  <p><strong>Interaction:</strong> AI alone flatlines commitment (Δ≈0); AI+anchoring produces the largest commitment gain (F=5.35, p=.022). Self-efficacy is null everywhere — a 10-minute intervention does not move self-reported confidence. AI ratings show only modest agreement with humans — strongest on the most structural dimensions (Specific ρ=.56, Time-Bound ρ=.48) and weak on subjective ones (Relevant ρ=.29), with the overall composite not reaching significance (ρ=.23). The AI is also systematically stricter than human raters, motivating a lighter-touch redesign for Paper 2. Only 5% of coached participants found feedback unhelpful and 48% persisted to all-strong, so frustration here is predominantly productive.</p>
  <p><strong>LIWC analysis (separate, not in this dashboard):</strong> Goal texts were exported and processed through LIWC-22 offline. AI coaching trades authenticity for structure — Authentic drops (d=-0.37, p=.023), while causal reasoning (cause d=+0.42, p=.002) and future-orientation (focusfuture d=+0.35, p=.024) increase. The anchoring manipulation check is unambiguous: pleasure visions are saturated with positive emotion (emo_pos 3.28 vs 0.76 in pain visions, p&lt;.0001) and pain visions with negative emotion (emo_neg 2.81 vs 0.59, p=.0002), with overall Tone 87 vs 49.</p>
