  ...
  return (
    <Card className="mx-auto max-w-xl p-6 space-y-5">
      <div className="text-center">
        <h2 className="font-display text-xl font-bold text-zinc-100">Emotional Anchoring</h2>
      </div>

      <div className="space-y-2">
        <label className="block text-sm font-medium text-zinc-200">The Vision</label>
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-zinc-200">The Cost</label>
        <p className="text-xs text-zinc-500">
